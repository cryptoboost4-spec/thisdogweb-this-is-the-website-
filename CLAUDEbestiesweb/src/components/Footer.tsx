    ...
    return (
        <footer className="py-20 sm:py-28 md:py-36 text-center bg-gradient-to-b from-primary/5 to-secondary/5 mt-12 sm:mt-16 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <button className="group relative px-12 sm:px-16 py-5 sm:py-7 rounded-full bg-gradient-to-r from-primary via-secondary to-primary text-white font-display text-2xl sm:text-3xl shadow-glow-pink hover:shadow-soft-hover transition-all duration-300 hover:scale-110 active:scale-95 overflow-hidden mx-auto">
