...
const SubHero: React.FC = () => {
    return (
        <section className="py-12 sm:py-16 text-center px-4 relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/4 w-[400px] h-[400px] bg-gradient-radial from-primary/10 to-transparent blur-3xl pointer-events-none animate-pulse-slow" />
            <div className="absolute top-1/2 right-1/4 w-[400px] h-[400px] bg-gradient-radial from-secondary/10 to-transparent blur-3xl pointer-events-none animate-pulse-slow" style={{ animationDelay: '1s' }} />
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="relative p-4 sm:p-6 bg-gradient-to-br from-orange-50 to-red-50 backdrop-blur-sm rounded-xl border-2 border-orange-200 space-y-3 sm:space-y-4 overflow-hidden group hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
